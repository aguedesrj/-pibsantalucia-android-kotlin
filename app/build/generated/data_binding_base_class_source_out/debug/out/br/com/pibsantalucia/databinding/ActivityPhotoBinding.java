...
public final class ActivityPhotoBinding implements ViewBinding {
  ...
  @NonNull
  public final CropImageView cropImageViewCongregado;

  private ActivityPhotoBinding(@NonNull ConstraintLayout rootView,
      @NonNull CropImageView cropImageViewCongregado) {
    this.rootView = rootView;
    this.cropImageViewCongregado = cropImageViewCongregado;
  }
  ...
  public static ActivityPhotoBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.cropImageViewCongregado;
      CropImageView cropImageViewCongregado = rootView.findViewById(id);
      if (cropImageViewCongregado == null) {
        break missingId;
      }

      return new ActivityPhotoBinding((ConstraintLayout) rootView, cropImageViewCongregado);
    }
